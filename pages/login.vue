      ...
      <form @submit.prevent="login" class="space-y-4">
        <div>
          ...
          <input type="email" v-model="email" id="email" placeholder="email@example.com" required
            class="w-full mt-1 px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500" />
        </div>

        <div>
          <label for="password" class="block text-gray-700">Password</label>
          <input type="password" v-model="password" id="password" placeholder="Your password" required
            class=" input-black w-full mt-1 px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500" />
        </div>

        <button type="submit" class="w-full bg-teal-500 text-white py-2 rounded-md hover:bg-teal-600 transition-colors">
          Accedi
        </button>
      </form>
